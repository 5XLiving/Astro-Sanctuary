...
window.I18N['th'] = {
  ...
  action:{
    weekly:'ประจำสัปดาห์',
    energy:'การฝึกพลังงาน',
    career:'กลยุทธ์อาชีพ: เดินหน้าอย่างมั่นคง เน้นผลงาน',
    career2:'ส่งมอบสม่ำเสมอและทบทวน (วางแผน→ทำ→ทบทวน→ปรับปรุง)',
    relationship:'ดูแลความสัมพันธ์: สื่อสารจริงใจ ตั้งขอบเขต ตอบกลับทันท่วงที',
    wealth:'การเงิน: งบประมาณ/กระแสเงินสด สร้างรายได้จากทักษะ ควบคุมความเสี่ยง'
  }
});
