...
window.I18N['zh-TW'] = {
  ...
  pro:{
    title:'🧙‍♂️ 心怜管家 · 專業命理分析',
    welcome:'你好！我已為你生成詳細分析，有任何具體問題隨時問我。'
  },

  chat:{ send:'發送', placeholder:'請輸入你的問題…', toggle:'問' },

  vip:{
    title:'🌙 會員專區',
    group:{ astrology:'🗝 命理空間', spiritual:'🌙 心怜空間' },
    astrology:{
      match:'姻緣方向：戀愛與婚姻節奏',
      career:'事業方向：職場發展與創業潛力',
      wealth:'財運方向：財位與時機',
      pet:'寵物命理：夥伴性格與緣分'
    },
    spiritual:{
      record:'靈性記錄：照片、夢境、音訊、願望',
      courses:'課程：八字 / 塔羅 / 占星 / 靈數',
      family:'家族紀念：追思與延續',
      practice:'每週能量練習 / 儀式任務'
    },
    login:{ title:'💎 登入 VIP 功能' },
    services:{ header:'會員服務' },
    upgrade:'💎 升級為 VIP（月費）',
    back:'← 返回命理商城',
    priceNote:'$9.9 / 月（命理空間 + 心怜空間 + 全部課程）'
  },
  ...
  auth:{
    ...
    reset:'🔑 重設密碼',
    register:'註冊帳戶',
    freeTrialNote:'註冊即贈一次免費體驗',
    emailPlaceholder:'信箱 Email',
    passwordPlaceholder:'密碼（至少8位，含大小寫與符號）'
  },
  ...
  err:{
    ...
    invalidDate:'無效日期格式，請使用 YYYY-MM-DD',
  ...
  chatDyn:{ autoReply:'收到：{q}。要點會出現在對應報告章節。' },
  ...
  wellness:{ default:'規律作息、適度運動、情緒穩定、少熬夜。' },
  cautions:{ default:'避免情緒化決策，控制支出。' },

  action:{
    weekly:'每週至少一次',
    energy:'元素「補能」行動（環境 / 食物 / 顏色 / 方位）。',
  ...
  'report.dayMaster.wu':'戊土命：主動積極，容易投入熱忱。',
  'report.dayMaster.ji':'己土命：和緩謹慎，心靈手巧。',
  'report.dayMaster.geng':'庚金命：果斷幹練，勇於決斷。',
